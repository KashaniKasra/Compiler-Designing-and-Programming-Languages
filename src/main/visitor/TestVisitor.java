...
public class TestVisitor extends Visitor<Void> {
    private ArrayList<String> statements_logs = new ArrayList<String>();
    ...
    public Void visit(CompilationUnit compilationUnit) {
        ...
        for (String msg : statements_logs)
    ...
    public Void visit(FunctionDefinition functionDefinition) {
        String msg = "Line " + functionDefinition.getLine() + ": Stmt function " + functionDefinition.getOriginalFunctionName() + " = " + extractStatementCount(functionDefinition.getCompoundStatement()) + " " + functionDefinition.computeParametersCount();
        statements_logs.add(msg);
    ...
    public Void visit(SelectionStatement selectionStatement) {
        String msg = "Line " + selectionStatement.getIfLine() + ": Stmt selection = " + extractStatementCount(selectionStatement.getBodyStatement());
        statements_logs.add(msg);
        ...
        if (selectionStatement.getElseIfBodyStatements() != null)
            for (Statement elseIfBodyStatement : selectionStatement.getElseIfBodyStatements())
                if (elseIfBodyStatement != null) {
                    ...
                    if (!(elseIfBodyStatement instanceof SelectionStatement)) {
                        String msg2 = "Line " + elseIfBodyStatement.getLine() + ": Stmt selection = " + extractStatementCount(elseIfBodyStatement);
                        statements_logs.add(msg2);
                    }
                }
        ...
        if (selectionStatement.getElseStatement() != null) {
            ...
            if (!(selectionStatement.getElseStatement() instanceof SelectionStatement)) {
                String msg3 = "Line " + selectionStatement.getElseLine() + ": Stmt selection = " + extractStatementCount(selectionStatement.getElseStatement());
                statements_logs.add(msg3);
            }
        }
    ...
    public Void visit(WhileIteration whileIteration) {
        String msg = "Line " + whileIteration.getLine() + ": Stmt while = " + extractStatementCount(whileIteration.getBodyStatement());
        statements_logs.add(msg);
    ...
    public Void visit(DoWhileIteration doWhileIteration) {
        String msg = "Line " + doWhileIteration.getLine() + ": Stmt do while = " + extractStatementCount(doWhileIteration.getBodyStatement());
        statements_logs.add(msg);
    ...
    public Void visit(ForIteration forIteration) {
        String msg = "Line " + forIteration.getLine() + ": Stmt for = " + extractStatementCount(forIteration.getBodyStatement());
        statements_logs.add(msg);
